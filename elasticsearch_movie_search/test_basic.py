...
def test_basic_functionality():
    ...
    print("🎬 MOVIE SEARCH ENGINE - QUICK TEST")
    print("=" * 50)
...
def main():
    ...
    if len(sys.argv) > 1 and sys.argv[1] == "--connection-only":
        ...
        if test_connection_only():
            ...
            print("\n❌ Cannot proceed with functionality tests - connection failed")

...
if box_office:
print(f"\nBox Office: Box Office Statistics:")
...
print(f"\nReference Movie:")
print(f" Title: {reference_movie.get('title', 'Unknown')}")
print(f" Genres: Genres: {', '.join(reference_movie.get('genres', []))}")
...
print(f"\nTip: Autocomplete suggestions for '{query}':")
...
print("\nGenres: Popular genres: Action, Adventure, Animation, Comedy, Crime, Drama, Fantasy, Sci-Fi, Thriller")
...
print(f"\nTitle: Getting details for movie ID {movie_id}...")
...
print("-" * 60)
print(f"Title: Title: {movie.get('title', 'Unknown')}")
print(f"Year: Year: {movie.get('release_year', 'N/A')}")
print(f" Rating: {movie.get('rating', 'N/A')}/10")
print(f"Genres: Genres: {', '.join(movie.get('genres', []))}")
print(f"Title: Director: {movie.get('director', 'Unknown')}")
print(f"Genres: Actors: {', '.join(movie.get('actors', []))}")
print(f"Duration: Duration: {movie.get('duration_minutes', 'N/A')} minutes")
print(f"Box Office: Box Office: ${movie.get('box_office', 0):,}")
print(f"\nDescription:")
